"""
Django settings for cloudcertifiedsupport project.
"""
...
ROOT_URLCONF = 'cloudcertifiedsupport.urls'
...
WSGI_APPLICATION = 'cloudcertifiedsupport.wsgi.application'
...
if not DEBUG:
    # Trust Azure's X-Forwarded-Proto header for HTTPS detection
